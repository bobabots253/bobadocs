...
The basic understanding of your images is can be best described by how you interact with your camera. Take for instance, your smartphone. It has a sensor, lenses that distort the image, and a place to store it. 

Every camera, from the oldest surviving museum pieces to the most expensive on the market, have these three basic neccessities. In layman's terms, anyone with no knowledge of a camera can operate it (like a Polaroid). But what changes from a "smartphone" image to a "professional" image is the person behind it and their understanding of how to use the other components of a camera.
...
In many instances of event photography, aperture is not a neccessary component to taking photos. A smaller aperture can help sharpen the photos, but it comes at a compromise of having to lower shutter speed or increase light sensitivity. (Light sensitivity, or ISO, is explained in the next section.)
...
Lenses differ in prices due to its sharpness and its "glass". Cheaper lenses are not as sharp, with chromatic abberation and softness on edges and corners. Lenses are the most important component to an image, as a cheap body and expensive lens produce better results than an expensive body and a cheap lens.
...
With a valid SMCL (San Mateo County Libraries) card, LinkedIn Learning resources are available for anyone to access. There are a variety of courses that can teach photography, videography, as well as advancing management skills and more. The following below are courses that covers the topics above.

Adobe, Nikon and B&H also cover the topics above, albiet with a bias to sell cameras. (Especially Nikon.)